...
$('.wrapper2').hide(0);
const checking = () => {
  if (document.querySelector('#true').onclick) {
    console.log('true');
  //   anim.style.height= '395px';
  //   anim.style.width = '550px';
  //   anim.innerHTML = '<h1>Good answer<h1><img src="trophy.jpg" alt="" srcset="">';
  //   // anim.style.background = 'green';
  //   anim.style.margin = '10px 900px 0 0';
  //   anim.style.padding = '25px 0 0 0';
  //  document.querySelector('#true').onclick = false; 
  //   anim.setAttribute('onclick', 'reset()');
...
const reset = () => {
  console.log('reset...');
  anim.setAttribute('onclick', 'checking()');
  anim.style.height= '40px';
    anim.style.width = '250px';
    anim.textContent = 'Check Result';
    anim.style.margin = '100px 0 0 0';
    anim.style.padding = '10px 0 0 0';
